...
class wcff_ajax {
	...
	private function handleRequest() {
	    ...
	    if (!is_user_logged_in() 
	        ...
	        && wcff()->request["context"] != "wcff_ajax_get_negotiated_price") {
	    	/**
	    	 * 
	    ...
	    if (wcff()->request["method"] == "GET") {
	        ...
	        if (wcff()->request["context"] == "product") {
	            ...
	            /**
	             * 
	             * Returns the search result for Products & Variations
	             * 
	             **/        		
        	    $data = wcff()->dao->search_posts(wcff()->request["payload"]["search"], wcff()->request["payload"]["post_type"], wcff()->request["payload"]["parent"]);
	        ...
	        } else if (wcff()->request["context"] == "variation_fields_map_product_list") {
	        ...
	        } else if (wcff()->request["context"] == "variation_fields_map_variation_list") {
    		...
    		if (wcff()->request["context"] == "field") {
    		     ...
    		     * 
    		     **/
    			$data = wcff()->dao->save_map_wccvf_variations(wcff()->request["payload"]);
    		...
    		if (wcff()->request["context"] == "field") {
    		     ...
    		     * 
    		     */  
    		    if (wcff()->dao->remove_wccvf_mapping(wcff()->request["payload"]["wccvf_id"], wcff()->request["payload"]["endpoint"])) {
    		        $message = "Successfully removed";
    		    } else {
    		        $status = false;
