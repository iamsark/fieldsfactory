...
function render_variation_fields_config_view() { 
    ...
    global $pagenow, $typenow, $post_type, $post_type_object;
        		...
        		<div class="wcff-variation-config-view">
        			...
        			<div class="wcff-variation-config-tab-header">
        				...
        				<div id="wcff-variation-config-action-bar">
        					<a href="<?php echo get_home_url()?>/wp-admin/post-new.php?post_type=wccvf" class="wcff-variation-config-action-btn new">New Fields Group</a>
        					<a href="#" class="wcff-variation-config-action-btn cancel" style="display: none;">Cancel</a>
        					<a href="#" class="wcff-variation-config-action-btn save" style="display: none;">Save</a>						 
        				</div>						
        			</div>		
        					...
        					<div class="wcff-variation-config-mapping-header">
        						<table>
        							<tr>
        								<td>
        									<div>
        										<input type="text" id="wcff-variation-config-product-search" class="wcff-variation-config-search-field" placeholder="Search Product ..." data-type="product" />
        										<ul id="wcff-variation-config-product-select" class="wcff-variation-config-popup" data-type="product"></ul>
        										<img src="<?php echo (plugin_dir_url(__FILE__) . '../assets/img/spinner.gif'); ?>" alt="loading">
        									</div>
        								</td>
        								<td>
        									<div>
        										<input type="text" id="wcff-variation-config-variation-search" class="wcff-variation-config-search-field" placeholder="Search for Variation ..." data-type="product_variation" />
        								...
        								<td>
        									<div>
        										<input type="text" id="wcff-variation-config-group-search" class="wcff-variation-config-search-field" placeholder="Search for Fields Group ..." data-type="wccvf" />
        										<ul id="wcff-variation-config-group-select" class="wcff-variation-config-popup" data-type="wccvf"></ul>
        										<img src="<?php echo (plugin_dir_url(__FILE__) . '../assets/img/spinner.gif'); ?>" alt="loading">
        									</div>
        								</td>
        								<td>
        									<button id="wcff-variation-config-map-btn" class="button button-primary">
        										<img src="<?php echo (plugin_dir_url(__FILE__) . '../assets/img/giphy.gif'); ?>" alt="loading"> Reset Mapping
        									</button>
        								</td>
        							</tr>
        						</table>
